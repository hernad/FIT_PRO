...
IS-a ćemo bazirati na softveru otvorenog koda \engl{open source software, OSS}.
...
\keywords{project, open source software, OSS, multiplatform software, business application, F18, ERP, bring.out, information system, IS}
\end{abstract}
